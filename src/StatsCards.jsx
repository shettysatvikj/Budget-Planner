...
//   const walletBalance = JSON.parse(localStorage.getItem("walletBalance")) || 0;
...
//   const totalSavingsFromGoals = goals.reduce((sum, g) => sum + (g.saved || 0), 0);

//   // Subtract savings from balance
//   const currentBalance = walletBalance - totalSavingsFromGoals;

//   const prevBalance = prevIncome - prevExpense; // previous balance calculation remains same
...
//     // Optional: Polling to capture changes within the same tab
...
//   return (
//     <div className="grid grid-cols-1 sm:grid-cols-2 p-5 lg:grid-cols-4 gap-4">

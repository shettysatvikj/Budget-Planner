...
//     { name: "Goals", icon: <Goal />, path: "/savinggoals" },
//     { name: "Budget", icon: <HandCoins />, path: "/budget" },
//     { name: "Analytics", icon: <ChartSpline />, path: "/analytics" },
//     { name: "Settings", icon: <Settings />, path: "/settings" },
//     { name: "Help", icon: <MessageCircleQuestionMark />, path: "/help" },
...
//   return (
//     <div className="p-5 w-[15%] h=full bg-[#ada7b438] flex flex-col">
...
//                 <p   className="flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer 
//              hover:bg-[#ff5151]/30 hover:scale-105 text-red-600 
//              transition-all duration-300 ease-in-out "  onClick={handleLogout}><LogOut/>Logout</p>
//             </ul>
//          </div>
//     </div>
//   );

...
export default function Signup() {
  ...
  const handleSignup = (e) => {
    ...
    localStorage.setItem("finsyncUser", JSON.stringify(userData));
      ...
      <div className="w-full max-w-sm bg-white/30 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border border-white/20">
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSignup}>
          ...
          <div className="relative">
            <User className="absolute left-3 top-1/2 -translate-y-1/2 text-[#7E62E6] z-10" size={20} />
            <input
              type="text"
        ...
        <p className="text-center mt-6 text-white/90">
          ...
          <Link to="/" className="text-[#7E62E6] ml-1 underline font-medium hover:text-[#9167f4] transition-colors">
            Login
          </Link>
        </p>
      </div>

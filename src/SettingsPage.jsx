...
//   // Load saved settings + signup user info
//   useEffect(() => {
//     const savedSettings = JSON.parse(localStorage.getItem("settings"));
//     const savedUser = JSON.parse(localStorage.getItem("finsyncUser")); // FIXED
...
//   return (
//     <div className="flex bg-[#f3f4f9] min-h-screen">
//       <Sidebar />

//       <div className="flex-1 p-10">
//         <h1 className="text-3xl font-bold text-gray-800 mb-8">Settings</h1>

//         <div className="bg-white p-8 rounded-3xl shadow-lg border max-w-xl transition-all duration-300 hover:shadow-xl">
...
//             className="w-full p-3 border rounded-xl mt-1 mb-5 focus:ring-2 focus:ring-purple-400 outline-none transition"
//           />
...
//             }
//             className="w-full p-3 border rounded-xl mt-1 mb-5 bg-gray-50"
//           >
